    ...
    <>
      ...
      <section className="bg-gray-800 px-6 py-12 md:py-16 w-full flex flex-col items-center">
        <div className="max-w-5xl text-white space-y-6 text-lg">
          ...
          <p>
            At Noname Exotics, we are committed to protecting your privacy. This policy explains how we collect,
            use, and safeguard your personal information when you visit our website or rent a vehicle from us.
          </p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>Driver Credentials: Drivers license, insurance information.</li>
          ...
          <p>
            Our website uses cookies to enhance user experience. By using our website, you consent to our use of
            cookies for:
          </p>
          <ul className="list-disc list-inside">
          ...
          <p>
            ...
            <a
              href="mailto:privacy@nonameexotics.com"
              className="text-blue-500 hover:underline"
            >
              privacy@nonameexotics.com
            </a>
            .
          </p>
          ...
          <h3 className="text-2xl font-semibold mt-6">8. Childrens Privacy</h3>
          <p>
            Our services are not intended for individuals under 18 years old. We do not knowingly collect data
            from minors.
          </p>
